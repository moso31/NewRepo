...
void DirectXPage::OnPointerMoved(Object^ sender, PointerEventArgs^ e)
{
	...
	m_main->TrackingUpdate(e->CurrentPoint->Position.X, e->CurrentPoint->Position.Y, e->CurrentPoint->Properties->IsLeftButtonPressed, e->CurrentPoint->Properties->IsRightButtonPressed);
}
...
{
	m_main->WheelChanged(e->CurrentPoint->Position.X, e->CurrentPoint->Position.Y, e->CurrentPoint->Properties->MouseWheelDelta);
}
