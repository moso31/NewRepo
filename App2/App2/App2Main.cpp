...
void App2Main::StopRenderLoop()
{
	m_renderLoopWorker->Cancel();
}

void App2Main::WheelChanged(float posX, float posY, int delta)
{
	m_sceneRenderer->WheelChanged(posX, posY, delta);
}

void App2Main::OnKeyDown(VirtualKey key)
{
	m_sceneRenderer->OnKeyDown(key);
}

void App2Main::OnKeyUp(VirtualKey key)
{
...
//在更新游戏状态之前处理所有用户输入
void App2Main::ProcessInput()
{
	// TODO: 按帧输入处理在此处添加。
	m_sceneRenderer->TrackingUpdate(m_pointerLocationX, m_pointerLocationY, m_pointerPressedL, m_pointerPressedR);
}
